...
import com.mshdabiola.drawing.internal.SketchPath
import com.mshdabiola.drawing.internal.copy
import com.mshdabiola.drawing.internal.defaultPaint
import com.mshdabiola.drawing.internal.initialSelectedIndex
...
class SketchbookController {
    ...
    /** Draws a [Path] with the current [Paint]. */
    fun addDrawPath(path: Path, paint: Paint) {
